...
***********************************************************************
   ...
   Methods:
      +ProgramOfStudy2()
      +addCourse(Course2 course):                  void
      +Course2 find(String prefix, int number)
      +size():                                     int
      +removeCourse(Course2 target):               void
      +replace(Course2 target, Course2 newCourse): void
      +toString():                                 String
      +Iterator<Course2> iterator()
      +save(String fileName):                      void
      +ProgramOfStudy2 load(String fileName):      static
